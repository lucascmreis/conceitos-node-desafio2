...
Este é o CRUD de uma API REST, aplicando os conceitos aprendidos durante o primeiro módulo do bootcamp GoStack da Rocketseat. 
Para validação  dos requisitos de testes, também foi utilizado o conceito de Middlewares.

Essa é uma aplicação para armazenar repositórios do seu portfólio, que permite:
* Criação
* Listagem
* Atualização e
* Remoção dos repositórios
* Além disso permite que os repositórios possam receber "likes".
...
Em cada teste, tem uma breve descrição sobre o que a aplicação deve cumprir para que o teste passe.
